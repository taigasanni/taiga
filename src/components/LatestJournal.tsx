      ...
      <div className="max-w-[1100px]">
        <ScrollReveal>
          ...
          <h2
            ...
            style={{ fontSize: "clamp(1.5rem, 3vw, 2.25rem)", fontWeight: 200 }}
          >
            思考の記録
          </h2>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6">
          {latest.map((entry, i) => (
            <ScrollReveal key={entry.slug} delay={i * 0.1}>
              ...
              >
                {/* Eyecatch */}
                <div className="relative aspect-[16/10] bg-[#1a1a1a]/[0.03] overflow-hidden mb-5">
                  {entry.eyecatch ? (
                    <Image
                      src={entry.eyecatch}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center group-hover:bg-[#1a1a1a]/[0.05] transition-colors duration-500">
                      <p className="text-[#1a1a1a]/8 text-xs tracking-wider">
                        Eyecatch
                      </p>
                    </div>
                  )}
                ...
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-xs text-[#1a1a1a]/25 tracking-wider">
                    {entry.category}
                  </span>
                  <span className="text-xs text-[#1a1a1a]/15">
                    {entry.date}
                  </span>
                </div>
                <h3
